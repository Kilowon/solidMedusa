...
export default function ProductTemplate(props: {
	...
	return (
		<Show when={props.productInfo}>
			<main>
				<div class="absolute md:static top-0 md:content-container md:flex md:flex-col lg:flex-row lg:items-start md:py-6  md:mt-10">
					...
					<div class="lg:sticky lg:top-20 md:w-full md:py-8 sm:py-0 md:max-w-[344px] lg:max-w-[400px]">
