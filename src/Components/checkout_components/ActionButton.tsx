...
export function ActionButton(props: ActionButtonProps) {
	return (
		<UnstyledButton
			class={clsx(
				'relative flex items-center justify-center rounded-sm w-[93vw] md:w-24 px-5 py-2.5 font-medium no-underline transition-colors md:text-lg lg:rounded-[5px] lg:px-4.5 lg:py-2 lg:text-xl',
