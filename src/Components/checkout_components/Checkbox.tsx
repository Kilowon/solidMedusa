...
export function Checkbox(props: CheckboxProps) {
	...
	return (
		<div class={clsx(!props.padding && 'px-2 lg:px-2', props.class)}>
			<label class="flex items-center select-none space-x-2 text-sm font-500 tracking-tighter text-balance">
				<input
					{...inputProps}
