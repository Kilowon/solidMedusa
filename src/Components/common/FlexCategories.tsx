								...
								{(category: any) => (
									<li class="flex flex-row pr-1 whitespace-nowrap">
										<A href={`/categories/${category?.handle}`}>
											<div
												class={
													category?.name === props.currentCategory()[0]?.name
														? 'text-amber-5'
														: ''
												}
											>
										...
										<div class={'pr-1 font-bold text-3xl flex flex-row items-center '}>
											<div
												class={
								...
								{(child: any, index) => (
									<div class="flex flex-row whitespace-nowrap">
										...
										<div class="flex flex-row items-center text-xl pr-1   ">
											<div
												class={
													props.currentCategory()[0]?.category_children.length ===
													index() + 1
														? ' '
