		...
		<Show when={true}>
			<div
				class={clsx(
					...
					props.item.component_variant === 'left' && 'flex-row-reverse py-10 items-center',
					props.item.component_variant === 'default' && 'py-10 items-center',
					props.item.component_variant === 'center' && ' py-10 items-center lg:items-end mb-15'
				)}
			>
